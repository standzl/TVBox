...
public class ApiConfig {
    ...
    private LinkedHashMap<String, SourceBean> sourceBeanList;   //站点源
    private SourceBean mHomeSource;
    private ParseBean mDefaultParse;
    private List<LiveChannelGroup> liveChannelGroupList;    //直播源
    private List<ParseBean> parseBeanList;  //解析地址集合
    private List<String> vipParseFlags; //需要VIP解析的站点名称集合
    ...
    public void loadConfig(boolean useCache, LoadConfigCallback callback, Activity activity) {
        ...
        if (useCache && cache.exists()) {
            LOG.i("cache file path:"+cache.getAbsolutePath());
            try {
